...
<?php $tecala = get_field('tecala');?>
     ...
     <section id="hero" class="d-flex align-items-start" style="background-image: url(<?php bloginfo('template_directory');?>/assets/img/heromkv.png);">
     <div class="container">
           <div class="container">
           <div class="section-title">
         
           <div class="row box-one"  data-aos="fade-right" data-aos-duration="2000" data-aos-delay="200">
...
<section id="expertise" class="d-flex align-items-start">
    <div class="container">
        <div class="section-page">
           ...
           <div class="row">
                  <div class="col-lg-12 d-lg-flex flex-lg-column justify-content-center align-items-stretch pt-5 pt-lg-0 order-2 order-lg-1" data-aos="fade-down" data-aos-duration="2000" data-aos-delay="1000" >
                ...
                <div class="row">
                  ...
                  <div class="col-lg-12 d-lg-flex flex-lg-column justify-content-center align-items-stretch pt-5 pt-lg-0 order-2 order-lg-1" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="200" >
...
<section id="whytecala" class="d-flex align-items-start" style="background-image: url(<?php bloginfo('template_directory');?>/assets/img/whymkv.png);">
    <div class="container">
        <div class="section-page">
           ...
           <div class="row">
                  ...
                  <h6>WHY TECALA</h6>  
                    ...
                    <div class="col-lg-8 d-lg-flex flex-lg-column justify-content-center align-items-stretch pt-5 pt-lg-0 order-2 order-lg-1" data-aos="fade-down" data-aos-duration="1000" data-aos-delay="100" >
        ...
        <div class="section-left">
         ...
         <div class="row">
           ...
           <div class="col-lg-4 d-lg-flex flex-lg-column justify-content-center align-items-stretch pt-5 pt-lg-0 order-2 order-lg-1" data-aos="fade-right" data-aos-duration="2000" data-aos-delay="200" >
         ...
         <div class="row">
           ...
           <div class="col-lg-4 d-lg-flex flex-lg-column justify-content-center align-items-stretch pt-5 pt-lg-0 order-2 order-lg-1" data-aos="fade-right" data-aos-duration="2000" data-aos-delay="300" >
         ...
         <div class="row">
           ...
           <div class="col-lg-4 d-lg-flex flex-lg-column justify-content-center align-items-stretch pt-5 pt-lg-0 order-2 order-lg-1" data-aos="fade-right" data-aos-duration="2000" data-aos-delay="400" >
...
<?php $bout = get_field('boutcomes');?>
    ...
    <div class="container">
        <div class="section-page">
           ...
           <div class="section-left">
           <div class="row">
                  <div class="col-lg-12 d-lg-flex flex-lg-column justify-content-center align-items-stretch pt-5 pt-lg-0 order-2 order-lg-1" data-aos="fade-down" data-aos-duration="3000" data-aos-delay="1000" >
                  <h6>BUSINESS OUTCOMES</h6>  
                  </div>
                </div> 
                <div class="row">
                
                  <div class="col-lg-12 d-lg-flex flex-lg-column justify-content-center align-items-stretch pt-5 pt-lg-0 order-2 order-lg-1" data-aos="fade-right" data-aos-duration="2000" data-aos-delay="200">
...
<div class="container" >
    <div class="section-footer">
                  ...
                  <div class="section-center">
                          <div class="row justify-content-center" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="200">
                            <div class="col-lg-12">
            ...
            <div class="section-center">
              ...
              <div class="row">
                ...
                <div class="col-lg-3 col-md-4" data-aos="fade-left" data-aos-duration="3000" data-aos-delay="100">
                <a class="footer-started" href="tel:1300"><?php echo $contact['button1'];?>Call 1300 TECALA</a>
                </div>
                <div class="col-lg-3 col-md-4" data-aos="fade-right" data-aos-duration="3000" data-aos-delay="100">
